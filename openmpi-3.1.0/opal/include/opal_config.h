...
/* Define to 1 if you have the declaration of `ethtool_cmd_speed', and to 0 if
   you don't. */
#define HAVE_DECL_ETHTOOL_CMD_SPEED 0
...
/* Version of hwloc */
#define HWLOC_HWLOC1117_HWLOC_VERSION "internal v1.11.7"
...
#define HWLOC_SYM_PREFIX opal_hwloc1117_

/* The hwloc symbol prefix in all caps */
#define HWLOC_SYM_PREFIX_CAPS OPAL_HWLOC1117_
...
#define MCA_hwloc_IMPLEMENTATION_HEADER "opal/mca/hwloc/hwloc1117/hwloc1117.h"
...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing  -D__EXTENSIONS__' CPPFLAGS='-I/Users/YJ/Documents/workspace/tensorflow/mlist/openmpi-3.1.0/opal/mca/event/libevent2022/libevent -I/Users/YJ/Documents/workspace/tensorflow/mlist/openmpi-3.1.0/opal/mca/event/libevent2022/libevent/include -I/Users/YJ/Documents/workspace/tensorflow/mlist/openmpi-3.1.0/opal/mca/hwloc/hwloc1117/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "3.1.0"
...
#define OPAL_ARCH "x86_64-apple-darwin16.7.0"
...
#define OPAL_CMA_NEED_SYSCALL_DEFS 1
...
#define OPAL_IDENT_STRING "3.1.0"
...
#define OPAL_PACKAGE_STRING "Open MPI YJ@yangjin-ui-MacBook-Pro.local Distribution"
...
#define OPAL_RELEASE_DATE "May 07, 2018"
...
#define OPAL_TARBALL_VERSION "3.1.0"
...
#define ORTE_CLEAN_PS_CMD "ps -A -o command,pid,uid"
...
#define ORTE_RELEASE_DATE "May 07, 2018"
...
#define OSHMEM_TARBALL_VERSION "3.1.0"
...
#define PACKAGE_STRING "Open MPI 3.1.0"
